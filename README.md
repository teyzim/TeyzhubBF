...
local Window = OrionLib:MakeWindow({Name = "Teyzhub Blox fruits", HidePremium = false, IntroText = "", SaveConfig = true, ConfigFolder = "Teyzhub Blox fruits"})
...
W:AddLabel("[+] Teyzhub Blox fruits is HERE!")
...
pcall(function()
    while wait() do
        if _G.AutoEliteHunter then
            if game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == true then
                OrionLib:MakeNotification({
                    Name = "Teyzhub Blox fruits(Noitification)",
